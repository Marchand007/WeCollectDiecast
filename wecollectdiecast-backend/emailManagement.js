...
{
    const mailOptions = {
        from : `We Collect Diecast <${process.env.EMAIL_EMAIL}>`,
...
function sendEmailToUser(recipient, subject, text, html)
{
    ...
    {
        const mailOptions = {
            from : `Support We Collect Diecast <${process.env.EMAIL_EMAIL}>`,
            to: recipient,
            subject: subject,
            text: text, // Corps du courriel en texte brut
            html: html, // Corps du courriel au format HTML (optionnel)
...
module.exports = { sendNewsletterEmail, sendEmail, sendEmailToUser };